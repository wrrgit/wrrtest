...
/**
 * https://blog.csdn.net/liqtbj/article/details/16946955
...
public class CustomNinePatch {
     ...
     * <code>null</code>.
     * @return a {@link CustomNinePatch} or <code>null</code>.
     * @throws IOException
     */
    public static CustomNinePatch load(URL fileUrl, boolean convert) throws IOException {
     ...
     * @throws IOException
     */
    public static CustomNinePatch load(InputStream stream, boolean is9Patch, boolean convert)
            throws IOException {
        BufferedImage image = null;
        try {
     ...
     * @throws IOException
     */
    public static CustomNinePatch load(BufferedImage image, boolean is9Patch, boolean convert) {
        if (is9Patch == false) {
            if (convert) {
        ...
        return new CustomNinePatch(image);
    }
    ...
    private CustomNinePatch(BufferedImage image) {
        mImage = image;
